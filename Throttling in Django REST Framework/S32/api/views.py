...
এই অংশে ScopedRateThrottle ক্লাস ব্যবহার করা হয়েছে থ্রটলিং (অনুরোধের হার সীমিত করা) করার জন্য। এর মানে হচ্ছে এই ভিউয়ের জন্য নির্দিষ্ট রেট অনুযায়ী রিকোয়েস্টগুলিকে সীমিত করা হবে।
throttle_scope = 'viewstu'

throttle_scope দ্বারা একটি স্কোপ সেট করা হয়েছে। এখানে স্কোপের নাম 'viewstu' দেওয়া হয়েছে। এর অর্থ হল, থ্রটলিং নিয়মগুলো এই স্কোপের ওপর নির্ভর করবে। স্কোপ অনুযায়ী কতবার এবং কত সময়ের মধ্যে রিকোয়েস্ট করা যাবে তা ডিফাইন করা যাবে Django Rest Framework-এর সেটিংসে।
'''
